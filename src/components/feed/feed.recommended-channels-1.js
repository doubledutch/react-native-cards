          ...
          <FeedCardWrapper title="Recommended Channels">
            <ScrollView
              ...
              { this.props.data.map((d) => {
                return (
                  <View key={d.ID} style={[ styles.personCard, { width: GET_CARD_WIDTH() } ] }>
                    ...
                    <View style={styles.profile}>
                      <View style={{ marginLeft: 0 }}>
                        ...
                        <Text style={[styles.profileName, { width: GET_CARD_WIDTH() - 20 }]} numberOfLines={2} lineBreakMode="tail">{d.Name}</Text>
                      </View>
                    </View>
